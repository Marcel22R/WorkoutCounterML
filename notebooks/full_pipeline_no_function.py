...
relativeUrl=relativeUrlWorkoutCounter
...
if len(nn_accuracies) > 1:  # Ensure enough data for t-tests
    ...
    ttest_results = [
        {"Comparison": "NN vs RF", "t-statistic": t_nn_rf, "p-value": p_nn_rf},
        {"Comparison": "NN vs DT", "t-statistic": t_nn_dt, "p-value": p_nn_dt},
        {"Comparison": "RF vs DT", "t-statistic": t_rf_dt, "p-value": p_rf_dt},
    ]
    print(ttest_results)
...
(
    ...
    X_train[feature_set_1], Y_train, X_test[feature_set_1], gridsearch=True
)
...
plt.title("Confusion matrix - Random Forest - feature set 1")
plt.colorbar()
